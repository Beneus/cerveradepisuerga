            ...
            ?>
               <div class="content">
                  <table role="table" id="noticias">
                     <thead role="rowgroup">
                        <tr role="row">
                           <th role="columnheader">Ruta</th>
                           <th role="columnheader">Inicio</th>
                           <th role="columnheader">Llegada</th>
                           <th role="columnheader">Distancia</th>
                     ...
                     <tbody role="rowgroup">
                        ...
                        ?>
                           <tr role="row">
                              <td role="cell"><?= $item->Ruta; ?></td>
                              <td role="cell"><?= $item->Inicio; ?></td>
                              <td role="cell"><?= $item->Llegada; ?></td>
                              <td role="cell"><?= $item->Distancia; ?></td>
                              <td role="cell">
                                 <div align="center">
