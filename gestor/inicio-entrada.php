...
<div id="opciones">
  <ul>
    <li class="liselect"><a title="A&ntilde;adir noticia" href="inicio-entrada.php">Editar</a></li>
    <li><a title="Listado del noticias"  href="galeria-fotografica.php?Ambito=Inicio&idAmbito=1&Campo=idInicio&NCampo=idInicio&Referer=inicio-entrada.php">A&ntilde;adir imagen</a></li>
  </ul>
</div>
<hr class="separador" />
<div id="contenido">
<form enctype="multipart/form-data" name="formEntrada" id="formEntrada" onsubmit="EnviarEntradaInicio(this,'nuevo');return false;">
