    ...
    <li class="campoform">
     ...
     <li class="campoform">
      ...
      <li class="campoform">
        ...
        <div class="valorentradaform">
          <a href="user-galeria-fotografica.php?Ambito=Monumentos&amp;idAmbito=<?php echo $idMonumento;?>&Campo=idMonumento&NCampo=Monumento&Referer=monumentos-editar.php">Galeria de imagenes</a>
        </div>    </li> 
        <li class="campoform">
        <div class="tituloentradaform">Galer&iacute;a documentos</div>
        <div class="valorentradaform">
          <a href="user-galeria-documentos.php?Ambito=Monumentos&amp;idAmbito=<?php echo $idMonumento;?>&Campo=idMonumento&NCampo=Monumento&Referer=monumentos-editar.php">Galeria de documentos</a>
        </div>    
        </li> 
