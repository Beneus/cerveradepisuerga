...
<div id="opciones">
<ul>
	<li class="liselect"><a title="A&ntilde;adir introducci&oacute;n" href="pesca-introduccion.php">Editar introducción</a></li>
	...
	<li><a title="A&ntilde;adir entrada al directorio" href="pesca-entrada.php">A&ntilde;adir entrada tramo de pesca</a></li>
	<li><a title="Listado del directorio"  href="pesca-listado.php">Listado tramo de pesca</a></li>
</ul>
</div>
<hr class="separador" />
<div id="contenido">
<form enctype="multipart/form-data" name="formEntrada" id="formEntrada" onsubmit="EnviarEntradaPescaIntroduccion(this,'nuevo');return false;">
