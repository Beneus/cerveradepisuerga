...
function GetQuery($buscar, $idNucleoUrbano)
{
    ...
    if ($idNucleoUrbano > 0) {
        $sql = $sql . " where Museos.idNucleoUrbano = $idNucleoUrbano ";
    }
    if ($buscar != "") {
        ...
        <tbody role="rowgroup">
            <tr role="row">
                ...
                if (($pagina > 1) and ($mostrar < $numTotalRegistros)) {
                    echo "<td role=\"cell\">";
                    echo "<a href=\"$pageName?pagina=" . ($pagina - 1) . "&mostrar=$mostrar&buscar=$buscar\" class=\"linkBlanco\"> << Anterior </a>";
                    echo "</td>";
                }
                if (($pagina < $numPags) and ($mostrar < $numTotalRegistros)) {
                    echo "<td role=\"cell\">";
                    echo "<a href=\"$pageName?pagina=" . ($pagina + 1) . "&mostrar=$mostrar&buscar=$buscar\" class=\"linkBlanco\"> Siguiente >> </a>";
                    echo "</td>";
                }
                ...
                <div id="opciones">
                    <ul>
                        ...
                        <?php if (($_SESSION["TipoUsuario"] == "ADMIN") or ($_SESSION["TipoUsuario"] == "USERCIT")) { ?>
                            <li><a href="museos-entrada.php">A&ntilde;adir entrada</a></li>
                        <?php } ?>
                    ...
                    <div class="content">
                        <table role="table" id="noticias">
                            ...
                            <tbody role="rowgroup">
                                ...
                                ?>
                                    <tr role="row">
                                        <td role="cell"><?= $item->Museo; ?></td>
                                        <td role="cell"><?= $item->Direccion; ?></td>
                                        <td role="cell"><?= $item->NombreNucleoUrbano; ?></td>
                                        <td role="cell"><?= $item->Telefono; ?></td>
                                        <td role="cell">
                                            <div align="center">
                                                <input type="button" name="EDITAR" value="Editar" class="boton_button" onclick="location.href='museos-editar.php?idMuseo=<?= $item->idMuseo; ?>&pagina=<?php echo $pagina; ?>&mostrar=<?= $sigmostrar; ?>&titulo=<?php echo $titulo; ?>'" />
                                            </div>
                                        </td>
                                        <td role="cell">
                                            <div align="center">
