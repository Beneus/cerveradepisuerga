...
<title>Gestor de contenidos: Monumentos entrada</title>
...
<div id="opciones">
  <ul>
    <li class="liselect"><a title="A&ntilde;adir monumento" href="monumentos-entrada.php">A&ntilde;adir entrada</a></li>
    <li><a title="Listado del monumentos"  href="monumentos-listado.php">Listado</a></li>
  </ul>
</div>
<div class="separador">&nbsp;</div>
<div id="contenido">
<form id="formEntrada" name="formEntrada" onsubmit="EnviarEntradaMonumento(this,'nuevo');return false;" method="post">
<div class="tablaizq">
<ul class="tablaformizq">
    ...
    <li class="campoform">
      ...
      <div class="valorentradaform">
        <input name="MONUMENTO" type="text" id="MONUMENTO" size="35" />
      </div>
     </li>
    <li class="campoform">
