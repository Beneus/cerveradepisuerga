...
if($max > 0){
	...
	header("Location:flora-listado.php");
	exit;
...
<div id="opciones">
  <ul>
    <li><a title="A&ntilde;adir entrada al directorio" href="flora-entrada.php">A&ntilde;adir entrada</a></li>
    <li><a title="Listado del directorio"  href="flora-listado.php">Listado</a> 
      <map name="Map" id="Map">
...
<div id="contenido">
<form id="formEntrada" name="formEntrada" onsubmit="EnviarEntradaFlora(this,'editar');return false;" method="post">
<div class="tablaizq">
...
<div class="tablader">
  <li class="campoform">
        ...
        <div class="valorentradaform">
         <a href="galeria-fotografica.php?Ambito=Flora&amp;idAmbito=<?php echo $idFlora;?>&amp;Campo=idFlora&amp;NCampo=Flora&amp;Referer=flora-editar.php">Galeria de imagenes</a>
        </div>    </li> 
        <li class="campoform">
        <div class="tituloentradaform">Galer&iacute;a de documentos</div>
        <div class="valorentradaform">
         <a href="galeria-fotografica.php?Ambito=Flora&amp;idAmbito=<?php echo $idFlora;?>&amp;Campo=idFlora&amp;NCampo=Flora&amp;Referer=flora-editar.php">Galeria de documentos</a>
        </div>    
        </li> 
</div>
<br class="limpiar" />
...
<ul class="tablaformtextolargo">
    ...
    <li class="campoform">
       ...
       <li class="campoform">
        <div class="tituloentradaform">Usos</div>
        <div class="valorentradaform"><textarea name="USOS" cols="80" rows="10" id="USOS"><?php echo $Usos; ?></textarea>
         </div>
        </li>
     <li class="campoform">
...
<input type="hidden" name="IDFLORA" value="<?php echo $idFlora;?>"/>
</form>
</div>
