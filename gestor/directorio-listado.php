...
location.href = "directorio-listado.php?Mostrar=<?php echo $Mostrar;?>&idNucleoUrbano=<?php echo $idNucleoUrbano;?>&idSubservicio="+x.value;

}
function SeleccionNucleoUrbano(x){
location.href = "directorio-listado.php?Mostrar=<?php echo $Mostrar;?>&idSubservicio=<?php echo $idSubservicio;?>&idNucleoUrbano="+x.value;

}
function Paginar(x){
location.href = "directorio-listado.php?idNucleoUrbano=<?php echo $idNucleoUrbano;?>&idSubservicio=<?php echo $idSubservicio;?>&Buscar=<?php echo $Buscar;?>&Mostrar="+x.value;

}
function CambiarPagina(x){
location.href = "directorio-listado.php?Mostrar=<?php echo $Mostrar;?>&idNucleoUrbano=<?php echo $idNucleoUrbano;?>&idSubservicio=<?php echo $idSubservicio;?>&Pagina="+x.value;

}
function Buscar(x){
location.href = "directorio-listado.php?Buscar=" + x.value;
}
</script>
</head>
...
<?php if(($_SESSION["TipoUsuario"]== "ADMIN") OR ($_SESSION["TipoUsuario"]== "USERCIT")){ ?>
    ...
    <?php }?>
<li class="liselect" ><a  href="directorio-listado.php" title="Listado del directorio" >Listado</a> </li>
</ul>
</div>
...
echo CrearSelect("IDSUBSERVICIO","idSubServicio","NombreSubServicio",$sql,$link,"","","",$accion,$idSubservicio );
?></td>
<td class="lateralizq">
...
. " from Directorio as D INNER JOIN NucleosUrbanos as NU ON D.idNucleoUrbano = NU.idNucleoUrbano  ";
...
if ($idNucleoUrbano > 0){ $sql = $sql . " where D.idNucleoUrbano = $idNucleoUrbano ";
if ($idSubservicio > 0 ) {$sql = $sql . " and  DSB.idSubservicio = $idSubservicio ";} 
}else{
if ($idSubservicio > 0 ) {$sql = $sql . " where  DSB.idSubservicio = $idSubservicio ";} 
}
...
<td><div align="center">
<input type="checkbox" name="idDir" value="<?php echo $row["idDirectorio"];?>"/>
</div></td>
<td><div align="center">
<input type="button" name="EDITAR" value="Editar" class="boton_button" onclick="location.href='directorio-editar.php?idDirectorio=<?php echo $row["idDirectorio"];?>&Pagina=<?php echo $Pagina;?>&Mostrar=<?php echo $sigMostrar;?>&titulo=<?php echo $titulo;?>'"/>
</div></td>
<td class="lateralizq">&nbsp;</td>
</tr>
