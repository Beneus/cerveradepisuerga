...
<title>Gestor de contenidos: Localizaci&oacute;n galer&iacute;a</title>
...
function stopUpload(){
      ...
      document.getElementById('FormImage').style.visibility = 'visible';
	  	location.href="localizacion-galeria.php?Ambito=Inicio&idAmbito=1";
	  	return true;   
}
...
<div id="opciones">
  <ul>
    <li><a title="A&ntilde;adir entrada al directorio" href="localizacion-entrada.php">Editar</a></li>
    <li class="liselect"><a title="Listado del directorio"  href="localizacion-galeria.php">A&ntilde;adir imagen</a> 
      <map name="Map" id="Map">
...
<div id="contenido">
<h3 align="center">Galeria de imagenes de Localizaci&oacute;n</h3>
<a href="localizacion-entrada.php">Volver a Editar </a>
...
<input type="hidden" name="AMBITO" value="Localizacion"/>
...
$sql = " SELECT Img.*,LOC.ImgDescripcion FROM Imagenes as Img "
			." inner join Localizacion as LOC on Img.idAmbito = LOC.idLocalizacion "
			." WHERE Ambito = 'Localizacion' AND idAmbito = 1 ";
	  ...
	  echo "<div class=\"DatosImagen\">\n";
		  ...
		  echo "<input type=\"text\" name=\"PIE\" value=\"".$Pie."\" style=\"display:none\" disabled=\"disabled\" onBlur=\"GuardarDatos('PIE',$idImagen);\" onchange=\"TextoModificado=true;\" size=\"50\" /></li>\n";
			...
			echo "<li>Publicar:<input type=\"checkbox\" name=\"PUBLICAR\" value=\"$idImagen\" onclick=\"Publicar($idImagen,this);\" ";
		 	...
		 	echo "</form>\n";
		 	echo "<li>Descripci&oacute;n: <input type=\"radio\" name=\"DESCRIPCION\" value=\"$idImagen\" onclick=\"AsociarImagen('ImgDescripcion',$idImagen,'Localizacion',this,'idLocalizacion',1);\" ";
