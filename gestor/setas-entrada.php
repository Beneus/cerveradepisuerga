...
<div id="opciones">
  <ul>
    ...
    <li class="liselect"><a title="A&ntilde;adir entrada al directorio" href="setas-entrada.php">A&ntilde;adir entrada gu&iacute;a micol&oacute;gica</a></li>
...
<ul class="tablaformizq">
    ...
    <li class="campoform">
      ...
      <div class="valorentradaform">
        <input name="NOMBRECOMUN" type="text" id="NOMBRECOMUN" size="35" />
      </div>
     </li>
    <li class="campoform">
        <div class="tituloentradaform">Nombre Cient&iacute;fico</div>
        <div class="valorentradaform"><input name="NOMBRECIENTIFICO" type="text" id="NOMBRECIENTIFICO" size="35" />
         </div>
        </li>
    <li class="campoform">
        <div class="tituloentradaform">Autor</div>
        <div class="valorentradaform">
          <input name="AUTOR" type="text" id="AUTOR" size="35" />
        </div>    </li>   
...
<ul class="tablaformder">
   <li class="campoform">
        ...
        <div class="valorentradaform">
      	...
      	<option value="ASCOMICETOS">ASCOMICETOS</option>
        <option value="BASIDIOMICETOS">BASIDIOMICETOS</option>
    ...
    <li class="campoform">
      ...
      <li class="campoform">
        ...
        <option value="Venenosa">Venenosa</option>
        <option value="Sin valor culinario">Sin valor culinario</option>
        <option value="Buena">Buena</option>
        <option value="Excelente">Excelente</option>
        <option value="Sin clasificar" selected="selected">Sin clasificar</option>
      </select>
        </div>    
      </li> 
</ul>
...
<ul class="tablaformtextolargo">
    ...
    <li class="campoform">
        ...
        <div class="valorentradaform">
          <textarea name="SOMBRERO" cols="80" rows="10" id="SOMBRERO"></textarea>
        </div>
        </li>
        <li class="campoform">
        <div class="tituloentradaform">Pie</div>
        <div class="valorentradaform">
          <textarea name="PIE" cols="80" rows="10" id="PIE"></textarea>
        </div>
        </li>
        <li class="campoform">
        <div class="tituloentradaform">Cuerpo</div>
        <div class="valorentradaform">
          <textarea name="CUERPO" cols="80" rows="10" id="CUERPO"></textarea>
        </div>
        </li>
        <li class="campoform">
        <div class="tituloentradaform">Laminas</div>
        <div class="valorentradaform">
          <textarea name="LAMINAS" cols="80" rows="10" id="LAMINAS"></textarea>
        </div>
        </li>
        <li class="campoform">
        <div class="tituloentradaform">Himenio</div>
        <div class="valorentradaform">
          <textarea name="HIMENIO" cols="80" rows="10" id="HIMENIO"></textarea>
        </div>
        </li>
        <li class="campoform">
        <div class="tituloentradaform">Exporada</div>
        <div class="valorentradaform">
          <textarea name="EXPORADA" cols="80" rows="10" id="EXPORADA"></textarea>
        </div>
        </li>
        <li class="campoform">
        <div class="tituloentradaform">Carne</div>
        <div class="valorentradaform">
          <textarea name="CARNE" cols="80" rows="10" id="CARNE"></textarea>
        </div>
        </li>
        <li class="campoform">
        <div class="tituloentradaform">Epoca y habitat</div>
        <div class="valorentradaform">
          <textarea name="EPOCAHABITAT" cols="80" rows="10" id="EPOCAHABITAT"></textarea>
        </div>
        </li>
        <li class="campoform">
        <div class="tituloentradaform">Comestibilidad</div>
        <div class="valorentradaform">
          <textarea name="COMESTIBILIDAD" cols="80" rows="10" id="COMESTIBILIDAD"></textarea>
        </div>
        </li>
        <li class="campoform">
        <div class="tituloentradaform">Comentarios</div>
        <div class="valorentradaform">
          <textarea name="COMENTARIOS" cols="80" rows="10" id="COMENTARIOS"></textarea>
        </div>
        </li>
     <li class="campoform">
