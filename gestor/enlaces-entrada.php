...
<hr class="separador" />
<div id="contenido">
<form enctype="multipart/form-data" name="formEntrada" id="formEntrada" onsubmit="EnviarEntradaEnlace(this,'nuevo');return false;" method="post">
<div class="textolargo">
<ul class="tablaformtextolargo">
    <li class="campoform">
      <div class="tituloentradaform">Texto enlace</div>
      <div class="valorentradaform">
        <input name="TEXTOENLACE" type="text" id="TEXTOENLACE" size="100" maxlength="100" />
      </div>
     </li>
   
       <li class="campoform">
        <div class="tituloentradaform">URL</div>
        <div class="valorentradaform"><input name="URLENLACE" type="text" id="URLENLACE" size="100" maxlength="255" /></div>
        </li>
        <li class="campoform">
