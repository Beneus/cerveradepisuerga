...
$editPage = 'flora-editar.php';
$listPage = 'flora.php';
$pageName = curPageName();

$entityName = __NAMESPACE__ . '\Model\Entities\Flora';
...
{
   $sql = "SELECT FLO.*, IMG.* FROM Flora AS FLO "
	." LEFT join Imagenes as IMG on FLO.ImgDescripcion = IMG.idImagen ";
   if ($buscar != "") {
