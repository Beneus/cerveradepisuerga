...
location.href = "user-monumentos-listado.php?idsubsevicio="+x.value;

}
function SeleccionNucleoUrbano(x){
location.href = "user-monumentos-listado.php?Mostrar=<?php echo $Mostrar;?>&idNucleoUrbano="+x.value;

}
function Paginar(x){
location.href = "user-monumentos-listado.php?idNucleoUrbano=<?php echo $idNucleoUrbano;?>&Mostrar="+x.value;

}
function CambiarPagina(x){
location.href = "user-monumentos-listado.php?Mostrar=<?php echo $Mostrar;?>&idNucleoUrbano=<?php echo $idNucleoUrbano;?>&Pagina="+x.value;

}
function Buscar(x){
location.href = "user-monumentos-listado.php?Buscar=" + x.value;
}
</script>
</head>
...
$sql = " Select M.idMonumento,M.Monumento,M.Direccion,NU.idNucleoUrbano,NU.NombreNucleoUrbano, M.Telefono,M.FechaInauguracion,M.FechaClausura,M.Descripcion,M.Horario from Monumentos as M "
." INNER JOIN NucleosUrbanos as NU ON M.idNucleoUrbano = NU.idNucleoUrbano "
." inner join UsuariosAcceso on M.idMonumento = UsuariosAcceso.idAmbito";
 $sql = $sql . " where UsuariosAcceso.Ambito ='Monumentos' and UsuariosAcceso.idusuario = ". $_SESSION['idUsuario'];
 
if ($idNucleoUrbano > 0){ $sql = $sql . " and M.idNucleoUrbano = $idNucleoUrbano ";}
	
if($Buscar != ""){
$sql .= " and(  M.Monumento like '%$Buscar%' "
...
<td>Nucleo Urbano</td>
<td>Horario</td>
<td class="columnaselect"><div align="center"></div></td>
...
<input type="button" name="EDITAR" value="Editar" class="boton_button" onclick="location.href='user-monumentos-editar.php?idMonumento=<?php echo $row["idMonumento"];?>&Pagina=<?php echo $Pagina;?>&Mostrar=<?php echo $Mostrar;?>&titulo=<?php echo $titulo;?>'"/>
</div></td>
<td class="lateralizq">&nbsp;</td>
</tr>
