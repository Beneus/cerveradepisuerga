...
<title>Gestor de contenidos: Inicio galer&iacute;a</title>
...
function stopUpload(){
      ...
      document.getElementById('FormImage').style.visibility = 'visible';
	  	location.href="inicio-galeria.php?Ambito=Inicio&idAmbito=1";
	  	return true;   
}
...
<div id="opciones">
  <ul>
    <li><a title="A&ntilde;adir entrada al directorio" href="inicio-entrada.php">Editar</a></li>
    <li class="liselect"><a title="Listado del directorio"  href="galeria-fotografica.php?Ambito=Inicio&idAmbito=1&Campo=idInicio&NCampo=idInicio&Referer=inicio-editar.php">A&ntilde;adir imagen</a> 
      <map name="Map" id="Map">
...
<div id="contenido">
<h3 align="center">Galeria de imagenes de Inicio</h3>
<a href="inicio-entrada.php">Volver a Editar </a>
...
<input type="hidden" name="AMBITO" value="Inicio"/>
...
$sql = " SELECT Img.*,INI.ImgDescripcion FROM Imagenes as Img "
			." inner join Inicio as INI on Img.idAmbito = INI.idInicio "
			." WHERE Ambito = 'Inicio' AND idAmbito = 1 ";
	  ...
	  echo "<div class=\"DatosImagen\">\n";
		  ...
		  echo "<input type=\"text\" name=\"PIE\" value=\"".$Pie."\" style=\"display:none\" disabled=\"disabled\" onBlur=\"GuardarDatos('PIE',$idImagen);\" onchange=\"TextoModificado=true;\" size=\"50\" /></li>\n";
			...
			echo "<li>Publicar:<input type=\"checkbox\" name=\"PUBLICAR\" value=\"$idImagen\" onclick=\"Publicar($idImagen,this);\" ";
		 	...
		 	echo "</form>\n";
		 	echo "<li>Descripci&oacute;n: <input type=\"radio\" name=\"DESCRIPCION\" value=\"$idImagen\" onclick=\"AsociarImagen('ImgDescripcion',$idImagen,'Inicio',this,'idInicio',1);\" ";
