...
$Pagina = $_GET["Pagina"];
$link = ConnBDCervera();
$sql = " Select * from Directorio inner join UsuariosAcceso on Directorio.idDirectorio =  UsuariosAcceso.idAmbito where UsuariosAcceso.idusuario = ".$_SESSION['idUsuario']." and  idDirectorio = $idDirectorio ";
    ...
    <li class="campoform">
      ...
      (dd/mm/aaaa)
       ...
       <img src="images/der.gif" alt="M�s al Este" width="14" height="14" border="0" onmouseover="this.style.cursor='pointer';"  onmousedown="PosicionarMapa('E');" onmouseup="clearInterval(idTime);" onmouseout="clearInterval(idTime);" />
        ...
        <div class="valorentradaform">
          <a href="user-galeria-fotografica.php?Ambito=Directorio&amp;idAmbito=<?php echo $idDirectorio;?>&amp;Campo=idDirectorio&amp;NCampo=NombreComercial&amp;Referer=directorio-editar.php">Galeria de imagenes</a>
        </div>    </li>
        <li class="campoform">
        <div class="tituloentradaform">Galer&iacute;a documentos</div>
        <div class="valorentradaform">
          <a href="user-galeria-documentos.php?Ambito=Directorio&amp;idAmbito=<?php echo $idDirectorio;?>&amp;Campo=idDirectorio&amp;NCampo=NombreComercial&amp;Referer=directorio-editar.php">Galeria de documentos</a>
        </div>    
        </li>
