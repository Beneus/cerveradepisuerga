...
<title>Gestor de contenidos: Localizaci&oacute;n entrada</title>
...
<div id="opciones">
  <ul>
    <li class="liselect"><a title="A&ntilde;adir noticia" href="localizacion-entrada.php">Editar</a></li>
...
<hr class="separador" />
<div id="contenido">
<form enctype="multipart/form-data" name="formEntrada" id="formEntrada" onsubmit="EnviarEntradaLocalizacion(this,'nuevo');return false;">
