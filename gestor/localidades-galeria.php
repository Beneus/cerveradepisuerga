...
$link = ConnBDCervera();
$sql = " Select * from NucleosUrbanos where idNucleoUrbano = $idAmbito ";
...
<title>Gestor de contenidos: Localidades galer&iacute;a</title>
...
function stopUpload(){
      ...
      document.getElementById('FormImage').style.visibility = 'visible';
	  	location.href="localidades-galeria.php?Ambito=<?php echo $Ambito;?>&idAmbito=<?php echo $idAmbito;?>";
	  	return true;   
}
...
<div id="opciones">
  <ul>
    <li><a title="A&ntilde;adir entrada al directorio" href="localidades-entrada.php">A&ntilde;adir entrada</a></li>
...
<div id="contenido">
<h3 align="center">Galeria de imagenes de <?php echo $NombreNucleoUrbano; ?></h3>
<a href="localidades-editar.php?idNucleoUrbano=<?php echo $idAmbito; ?>">Volver a Editar <?php echo $NombreNucleoUrbano; ?></a>
...
$sql = " SELECT Img.*,NU.ImgDescripcion,NU.ImgHistoria FROM Imagenes as Img "
			." inner join NucleosUrbanos as NU on Img.idAmbito = NU.idNucleoUrbano "
	  ...
	  echo "<div class=\"DatosImagen\">\n";
		  ...
		  echo "<input type=\"text\" name=\"PIE\" value=\"".$Pie."\" style=\"display:none\" disabled=\"disabled\" onBlur=\"GuardarDatos('PIE',$idImagen);\" onchange=\"TextoModificado=true;\" size=\"50\" /></li>\n";
			...
			echo "<li><strong>Publicar: </strong><input type=\"checkbox\" name=\"PUBLICAR\" value=\"$idImagen\" onclick=\"Publicar($idImagen,this);\" ";
		 	...
		 	echo "</form>\n";
		 	echo "<li><strong>Descripci&oacute;n: </strong><input type=\"radio\" name=\"DESCRIPCION\" value=\"$idImagen\" onclick=\"AsociarImagen('ImgDescripcion',$idImagen,'$Ambito',this,'idNucleoUrbano',$idAmbito);\" ";
		 	if($ImgDescripcion == $idImagen){echo "checked";}
		 	echo "/></li>\n";
		 	echo "<li><strong>H�storia: </strong><input type=\"radio\" name=\"HISTORIA\" value=\"$idImagen\" onclick=\"AsociarImagen('ImgHistoria',$idImagen,'$Ambito',this,'idNucleoUrbano',$idAmbito);\" ";
