<?php
namespace Citcervera\Models\Connections;

use Citcervera\Models\Interfaces\IConnection;
//use Citcervera\Moddels\Entities\IEntityBase;
use mysqli;

include_once('Models/Interfaces/IEntityBase.php');
include_once('Models/Interfaces/IConnection.php');
