...
include_once('Models/Managers/DataCarrier.php');
include_once('Models/Managers/Manager.php');
include_once('Models/Entities/Agenda.php');
include_once('Models/Entities/Santoral.php');
include_once('Models/Entities/NucleosUrbanos.php');
include_once('Models/Entities/TipoEvento.php');
...
function SantosDia(\Citcervera\Models\Managers\DataCarrier $dc, $mes, $dia)
{
...
function PintaMes($mes,$dia,$ano,$idNucleoUrbano,$idTipoEvento,\Citcervera\Models\Managers\DataCarrier $dc)
{
