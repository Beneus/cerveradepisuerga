...
<div id="opciones">
  <ul>
    <li class="liselect"><a title="A&ntilde;adir entrada al directorio" href="flora-entrada.php">A&ntilde;adir entrada</a></li>
...
<div id="contenido">
<form id="formEntrada" name="formEntrada" onsubmit="EnviarEntradaFlora(this,'nuevo');return false;" method="post">
<div class="tablaizq">
<ul class="tablaformizq">
    ...
    <li class="campoform">
        ...
        <div class="valorentradaform">
          <input name="FAMILIA" type="text" id="FAMILIA" size="35" />
        </div>    </li>   
</ul>
</div>
<div class="tablader">
...
<ul class="tablaformtextolargo">
    ...
    <li class="campoform">
        ...
        <div class="valorentradaform"><textarea name="HABITAT" cols="80" rows="10" id="HABITAT"></textarea>
         </div>
        </li>
       <li class="campoform">
        <div class="tituloentradaform">Usos</div>
        <div class="valorentradaform"><textarea name="USOS" cols="80" rows="10" id="USOS"></textarea>
         </div>
        </li>
     <li class="campoform">
