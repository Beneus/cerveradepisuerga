...
var urldest = "flora-eliminar.php";
...
location.href = "flora-listado.php?idsubsevicio="+x.value;

}
function SeleccionNucleoUrbano(x){
location.href = "flora-listado.php?Mostrar=<?php echo $Mostrar;?>&idNucleoUrbano="+x.value;

}
function Paginar(x){
location.href = "flora-listado.php?idNucleoUrbano=<?php echo $idNucleoUrbano;?>&Mostrar="+x.value;

}
function CambiarPagina(x){
location.href = "flora-listado.php?Mostrar=<?php echo $Mostrar;?>&idNucleoUrbano=<?php echo $idNucleoUrbano;?>&Pagina="+x.value;

}
function Buscar(x){
location.href = "flora-listado.php?Buscar=" + x.value;
}
</script>
</head>
...
<div id="opciones">
<ul>
<li><a title="A�&copy; r entrada al directorio" href="flora-entrada.php">A&ntilde;adir entrada</a></li>
<li class="liselect" ><a  href="flora-listado.php" title="Listado del directorio" >Listado</a> </li>
</ul>
</div>
...
$sql = "SELECT idFlora, NombreComun, NombreCientifico, Familia FROM Flora ";

if($Buscar != ""){
$sql .= " where  Flora.NombreComun like '%$Buscar%' "
. " or Flora.NombreCientifico like '%$Buscar%' "
. " or Flora.Familia like '%$Buscar%' "
. " or Flora.Descripcion like '%$Buscar%' "
. " or Flora.Habitat like '%$Buscar%' "
. " or Flora.Usos like '%$Buscar%' "; 
}
...
<td><div align="center">
<input type="checkbox" name="idDir" value="<?php echo $row["idFlora"];?>"/>
</div></td>
<td><div align="center">
  <input type="button" name="EDITAR" value="Editar" class="boton_button" onclick="location.href='flora-editar.php?idFlora=<?php echo $row["idFlora"];?>&page=<?php echo $pagina_actual;?>&titulo=<?php echo $titulo;?>'"/>
</div></td>
<td class="lateralizq">&nbsp;</td>
</tr>
...
echo "<a href=\"flora-listado.php?Pagina=".($Pagina - 1)."&Mostrar=$Mostrar&buscar=$Buscar&idNucleoUrbano=$idNucleoUrbano&idSubservicio=$idSubservicio\" class=\"linkBlanco\"> << Anterior </a>";
}else{
//echo "<img src=\"images/pag_der_d.gif\" width=\"9\" height=\"13\" border=\"0\">";
}
if(($Pagina < $numPags ) and ($Mostrar < $NumTotalRegistros)){
//echo "<a href=\"directorio-listado.php?Pagina=".($Pagina + 1)."&Mostrar=$Mostrar&buscar=$Buscar&idNucleoUrbano=$idNucleoUrbano&idSubservicio=$idSubservicio\"><img src=\"images/pag_der_a.gif\" width=\"9\" height=\"13\" border=\"0\"></a>";
echo "<a href=\"flora-listado.php?Pagina=".($Pagina + 1)."&Mostrar=$Mostrar&buscar=$Buscar&idNucleoUrbano=$idNucleoUrbano&idSubservicio=$idSubservicio\" class=\"linkBlanco\"> Siguiente >> </a>";
}else{
