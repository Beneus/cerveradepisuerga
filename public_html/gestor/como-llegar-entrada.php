...
<title>Gestor de contenidos: C&oacute;mo llegar entrada</title>
...
<div id="opciones">
  <ul>
    <li class="liselect"><a title="A&ntilde;adir noticia" href="como-llegar-entrada.php">Editar</a></li>
    <li><a title="Listado del noticias"  href="galeria-fotografica.php?Ambito=ComoLlegar&idAmbito=1&Campo=idComoLlegar&NCampo=idComoLlegar&Referer=como-llegar-entrada.php">A&ntilde;adir imagen</a></li>
  </ul>
</div>
<hr class="separador" />
<div id="contenido">
<form enctype="multipart/form-data" name="formEntrada" id="formEntrada" onsubmit="EnviarEntradaComoLlegar(this,'nuevo');return false;">
